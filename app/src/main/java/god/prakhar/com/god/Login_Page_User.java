 ...
 */
public class Login_Page_User extends Activity {
    ...
    private String urlJsonObj = "http://hindi.pythonanywhere.com/User/";
    private ProgressDialog pDialog;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.login_page_user);
        ...
        if (!str.equals("N/A"))
        {
            intent = new Intent(Login_Page_User.this,MainActivity.class);
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Login_Page_User.this,Signup.class);
                startActivity(intent);
            }
        });
        ...
        tv2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Login_Page_User.this,Login_Page_Admin.class);
                startActivity(intent);
            }
        });
    }
